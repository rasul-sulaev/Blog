...
<body>
    <div class="wrapper">
        <?php include "app/components/admin-header.php"; ?>
        <main>
                    ...
                    <div class="row h-100">
                        ...
                        <div class="main-content col-12 col-md-9">
                            <div class="d-flex gap-2 my-3">
                                <a class="btn btn-success w-auto" href="/admin/categories/create/">Добавить</a> <br>
                                <a class="btn btn-warning w-auto" href="/admin/categories/">Редактировать</a>
                            </div>
                            <div class="add-post">
