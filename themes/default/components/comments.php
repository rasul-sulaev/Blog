<?php
    include "../src/controllers/CommentsController.php";
?>
<div id="comments" class="col-md-12 col-12 comments pt-5">
    ...
    <p class="not">Только авторизованные пользователи могут оставлять комментарии. <a href="/themes/default/views/login.php">Войдите</a>, пожалуйста!</p>
    </blockquote>
    <? else: ?>
